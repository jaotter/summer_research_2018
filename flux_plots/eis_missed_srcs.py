...
data = Table.read(f'{basepath}/tables/r0.5_catalog_bgfit_jun20.fits')
...
#load in eisner data:
eisner_data = Table.read(f'{basepath}/tables/eisner_tbl.txt', format='ascii')
eis_coord_tab = Table.read(f'{basepath}/tables/eis_coord_table.fits')

eis_match_tab = Table.read(f'{basepath}/tables/eis_r0.5_jun20_match.fits')
