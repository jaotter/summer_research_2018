...
#print('B3 resolved')
#median = KM_median(B3_fwhm_resolved, B3_fwhm_flag_resolved, return_type='median')
#ci = bootstrap_ci(1000, B3_fwhm_resolved, B3_fwhm_flag_resolved)
#print(f'{median} +/- {ci}')
#median, lower, upper = KM_median(B3_fwhm_resolved, B3_fwhm_flag_resolved, return_type='percentile')
#print(f'{median} - {lower} + {upper}')

#print('B3')
#median = KM_median(B3_fwhm, B3_fwhm_flag, return_type='median')
#ci = bootstrap_ci(1000, B3_fwhm, B3_fwhm_flag)
#print(f'{median} +/- {ci}')
...
#ci = bootstrap_ci(1000, B6_fwhm, B6_fwhm_flag)
#print(f'{median} +/- {ci}')
...
#ci = bootstrap_ci(1000, B7_fwhm, B7_fwhm_flag)
#print(f'{median} +/- {ci}')
...
omc1_resolved = np.where(np.isnan(omc1) == False)
omc1 = omc1[omc1_resolved]
omc1_flag = omc1_flag[omc1_resolved]
