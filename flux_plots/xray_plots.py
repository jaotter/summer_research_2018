...
tab_ir = Table.read('/home/jotter/nrao/summer_research_2018/tables/IR_matches_MLLA_apr20_full_edit.fits')

coup = Table.read('/home/jotter/nrao/summer_research_2018/tables/COUP_r0.5_jun20.fits')
coup_ir = Table.read('/home/jotter/nrao/summer_research_2018/tables/COUP_r0.5_jun20_IRmatch.fits')

fb = Table.read('/home/jotter/nrao/summer_research_2018/tables/Forbrich2016_r0.5_jun20.fits')
