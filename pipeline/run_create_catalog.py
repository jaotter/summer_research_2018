...
B3dr = '/home/jotter/nrao/images/Orion_SourceI_B3_continuum_r'
...
B7_img_conv = '/home/jotter/nrao/images/B7_convolved_0.5.clean0.05mJy.250klplus.deepmask.image.tt0.pbcor.fits'
B7_name_conv = 'conv_B7_r0.5.clean0.05mJy.250klplus.deepmask'

single_img_catalog(B3_img, B3_name, B6_img_conv, B6_name_conv, B7_img_conv, B7_name_conv, 'r0.5_catalog_conv_snr', nonconv_B6_img=B6_img, nonconv_B7_img=B7_img)
