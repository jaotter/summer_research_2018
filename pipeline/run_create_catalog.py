...
single_img_catalog(B3_img, B3_name, B6_img_conv, B6_name_conv, B7_img_conv, B7_name_conv, 'r0.5_catalog_conv_apflux_final', nonconv_B6_img=B6_img, nonconv_B7_img=B7_img)
