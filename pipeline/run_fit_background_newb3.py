...
#fit_param_tab = Table.read('/home/jotter/nrao/summer_research_2018/tables/b7_fit_params.csv')
fit_param_tab = Table.read('/home/jotter/nrao/summer_research_2018/tables/b6_fit_params.csv')
...
for fit_row in fit_param_tab:
    ...
    fit = fit_source(src, img, B6_name, 'B6', fit_bg=bgfit, bg_stddev_x=xsigma, bg_stddev_y=ysigma, bg_mean_x=xmean, bg_mean_y=ymean, zoom=zoom, max_offset_in_beams=5, nonconv_img=nonconv_img)
    print(fit)
...
#catalog.write('/home/jotter/nrao/summer_research_2018/tables/r0.5_b7_catalog_bgfit_may21.fits',overwrite=True)
catalog.write('/home/jotter/nrao/summer_research_2018/tables/r0.5_b6_catalog_bgfit_may21_refit.fits',overwrite=True)
