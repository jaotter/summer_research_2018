...
#ref_table.write('/lustre/cv/observers/cv-12578/orion_disks/tables/ref_catalog_feb21_updt.fits', overwrite=True)


ref = Table.read('/lustre/cv/observers/cv-12578/orion_disks/tables/ref_catalog_feb21.fits')
tab = Table.read('/lustre/cv/observers/cv-12578/orion_disks/tables/r0.5_catalog_feb21.fits')

ref['RA_B3'] = tab['RA_B3']
ref['DEC_B3'] = tab['DEC_B3']

ref.write('/lustre/cv/observers/cv-12578/orion_disks/tables/ref_catalog_feb21_updt.fits', overwrite=True)
