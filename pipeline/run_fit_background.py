...
catalog = Table.read('/home/jotter/nrao/summer_research_2018/tables/r0.5_catalog_apr20.fits')
...
B6_dict = {81:[2,0,0,50,50], 29:[2,0,0,30,30], 28:[1.5,0,0,50,50], 72:[3.5,0,0,35,35], 39:[1.5,0,0,50,50], 18:[2,0,0,40,40], 50:[2,0,0,40,60], 10:[4.5,0,0,30,30], 13:[4,0,0,40,40],
           16:[13,0,0,30,30], 18:[4,0,0,30,30], 33:[4.5,0,0,30,30], 34:[8,0,0,30,30], 37:[3.5,0,0,30,30], 55:[3.5,0,0,30,30], 71:[9.5,0,0,30,30], 76:[3.5,0,0,30,30], 80:[8,0,0,30,30],
           83:[4,20,-20,30,30], 84:[4.5,0,0,30,30]}

B6_nonconv_img = [16,34,80,83] #B6 sources which should use non convolved image
...
B7_nonconv_img = [16,18,33,34,50,76,80,81,83]
